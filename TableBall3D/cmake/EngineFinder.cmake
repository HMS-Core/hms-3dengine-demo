...
if(DEFINED ENV{USERPROFILE} AND EXISTS $ENV{USERPROFILE})
    set(manifest_path $ENV{USERPROFILE}/.h3dengine/h3dengine_manifest.json) # Windows
else()
    set(manifest_path $ENV{HOME}/.h3dengine/h3dengine_manifest.json) # Unix
endif()

set(registration_error [=[
Engine registration is required before configuring a project.
Run 'scripts/h3dengine register --this-engine' from the engine root.
]=])

# Read the ~/.h3dengine/h3dengine_manifest.json file and look through the 'engines_path' object.
